...
> **New here?** [ADDING_A_MODEL.md](ADDING_A_MODEL.md) is the walkthrough for adding a
> model (work in progress). This file is the quick reference for the package contract
> and the compile steps.
