...
try {
  ...
  note(ui.text.includes("now or") && ui.text.includes("later?"), "renders the inline tutorial stimulus");
  ...
  note(debugUi.text.includes("Estimated parameters"), "tutorial debug debrief shows posterior summary");
